...
import { AUTH_COOKIE_NAME, validateAuthCookie } from "@/lib/auth"
...
async function userExists(email: string) {
  try {
    ...
    console.error("Erreur lors de la lecture de la base users.db", error)
    return false
  }
}
...
function parseAuthEmail(cookieValue?: string) {
  ...
  return validateAuthCookie(cookieValue)
}
